      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center px-6 max-w-7xl mx-auto w-full">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-[6.5rem] font-display tracking-widest uppercase mb-6 leading-[0.85] text-white hover-glitch relative"
            data-text="LOCAL AUDIO PLATFORM"
          >
            LOCAL AUDIO <br className="hidden md:block" />
          ...
          >
            <p className="mb-4 text-white font-bold">Your original content, managed by Media Mafias.</p>
            <p className="text-secondary">We distribute your work across global platforms through our advanced Content API. We guarantee a transparent and absolutely fair share of the revenue generated by your creative genius.</p>
          </motion.div>
