    ...
    <footer className="bg-black py-16 px-6 border-t border-red-accent/20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-4 font-mono text-sm uppercase tracking-widest text-secondary">
            ...
            <li><Link href="/blog" className="hover:text-white transition-all">Blog / Updates</Link></li>
      ...
      <div className="max-w-6xl mx-auto mt-16 pt-12 border-t border-white/10 relative z-10">
        ...
        <div className="flex flex-wrap justify-center items-center gap-10 md:gap-16 opacity-70">
          ...
          <div className="flex items-center justify-center hover:opacity-100 hover:text-red-accent transition-all cursor-pointer group" title="The Future Radio">
            <div className="w-10 h-10 rounded-full bg-black border border-white/10 flex items-center justify-center group-hover:scale-110 transition-transform relative overflow-hidden">
              <Image 
                src="/player-logo.png" 
          ...
          <div className="flex items-center justify-center hover:opacity-100 hover:text-[#FF0000] transition-all cursor-pointer group" title="YouTube">
          ...
          <div className="flex items-center justify-center hover:opacity-100 hover:text-[#1877F2] transition-all cursor-pointer group" title="Facebook">
          ...
          <div className="flex items-center justify-center hover:opacity-100 hover:text-[#1DB954] transition-all cursor-pointer group" title="Spotify">
          ...
          <div className="flex items-center justify-center hover:opacity-100 hover:text-[#2ECA7F] transition-all cursor-pointer group" title="JioSaavn">
            <div className="w-8 h-8 flex items-center justify-center group-hover:scale-110 transition-transform">
              <svg className="w-full h-full fill-current text-white group-hover:text-[#2ECA7F]" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-center hover:opacity-100 hover:text-[#E1306C] transition-all cursor-pointer group" title="Instagram">
